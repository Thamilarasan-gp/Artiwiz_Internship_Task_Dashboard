...
import { DollarSign,TrendingUp,TrendingDown,Clock10Icon,Percent,Users2Icon, Calendar, PercentCircleIcon,TrendingDownIcon} from "lucide-react";
function Cards() {
  return (
    <div className='Card-container'>
      <div className='card'>
<h2 className='card-title'>Total Outstanding</h2>
 <DollarSign className='card-icon' size={16}/>
...
<Users2Icon  className='card-icon' size={16}/>
...
<Clock10Icon className='card-icon' size={16}/>
<h3 className='card-count'>12.3</h3>
<p className='card-percent-red' ><TrendingDownIcon style={{transform: 'scaleX(-1)'}} size={14}/> -2.1% from last month</p>
